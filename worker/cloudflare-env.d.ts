/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ea0c425ba6c3fbd81e99453a79c04f6a)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	AGENT_STORAGE: R2Bucket;
	BROWSER: BrowserRun;
	AI: Ai;
	WEEKLY_WORKFLOW: Workflow<Parameters<import("./index").WeeklyWorkflow['run']>[0]['payload']>;
}
